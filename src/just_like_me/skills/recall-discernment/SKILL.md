...
```shell
hindsight memory recall just_like_me "<current goal, constraints and alternatives>" --fact-type world,observation --max-tokens 2048 --prefer-observations --output yaml
```
